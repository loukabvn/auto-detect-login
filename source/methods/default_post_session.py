...
class DefaultPostSession(usersession.AbstractUserSession):
    """
    ...
    def __init__(self, host, login_path, user_field, pwd_field, valid_status_code=None, **kwargs):
        super().__init__(host, login_path, **kwargs)
        self.user_field = user_field
        self.pwd_field  = pwd_field
        self.valid_status_code = valid_status_code if valid_status_code else self.DEFAULT_VALID_STATUS_CODE
